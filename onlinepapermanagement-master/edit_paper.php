...
<div class = "header">
  ...
  <table style= "color:#FFFFFF;padding-top:10px;">
   <tr>
     <td>ID :</td>
     <td><input type="number" name="booksname" placeholder="Paper ID"/></td>
     </tr>
	<tr>
	  <td>Paper Name :</td>
...
<div  style="background-color:orange; border:solid 2px orange;border-radius: 10px; width:74%; height:40px; margin-left:13%; margin-top:15px" >
          <marquee behavior="alternate" direction="right" loop="1" style="margin-right:38%" align="center"><h6 style="line-height:1px;">All content copyright &copy; Bariyait, Inc.</h6></marquee>
