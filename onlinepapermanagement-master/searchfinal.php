 ...
 $file_name=['file'];
  ...
  {  
	...
	else
	{
      ...
      $sql=
"UPDATE `papers` SET  `book_id`='$id',`papername`='$bookname',`authorname`='$authorname',`publisher`='$copy',`year`='$year',`file_name`='$file_name',`path`='$fpath' where id='$idd' ";
      //UPDATE `papers` SET `papername`='jdfh',`authorname`='fff',`publisher`='fdfsd',`year`='2020-5-2',`file_name`='5.pdf',`path`='ebook/4.pdf' WHERE id=2
...
<div class = "header">
  ...
  <tr>
   ...
   <tr>
     <td>Paper Name</td>
     <td><input type="text" name="booksname" placeholder="Papername"/></td>
     </tr>
	<tr>
	  <td>Author Name  :</td>
    <td><input type="text" name="authorname" placeholder="Authorname"/></td>
	</tr>
   <!-- <tr>
     <td>Author Name :</td>
